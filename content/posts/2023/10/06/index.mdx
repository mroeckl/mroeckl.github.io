...
Das Marktstammdatenregister bietet eine API an, über die man mit verschiedenen Filtern die registrierten Anlagen abrufen kann. Die empfangenen Daten habe ich in einem Balkendiagramm visualisiert.
