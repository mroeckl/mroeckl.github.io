...
Leider verlässt der Stromzähler nach 120 Sekunden Inaktivität den erweiterten Modus und dadurch wieder nur der reduzierte Datensatz auf der Info-DSS ausgegeben.
...
Die Lösung läuft bei mir jetzt seit 4 Monaten problemlos und ich hoffe, ich kann mit diesem Blogpost dem ein oder anderen helfen, ähnliche Probleme zu lösen. Viel Erfolg!
